 ...
 */
const TripForm = ({ onSubmit, onReset }) => {
    ...
    <div className="glass-panel rounded-3xl p-6 shadow-2xl space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-5" noValidate>
        ...
        <div className="flex items-center space-x-3 pt-3">
          <button
            type="submit"
            className="flex-1 py-3.5 px-5 bg-gradient-to-r from-indigo-600 via-indigo-500 to-cyan-500 hover:from-indigo-500 hover:to-cyan-400 text-white font-bold rounded-xl shadow-xl shadow-indigo-600/30 hover:shadow-indigo-600/50 transition-all duration-200 flex items-center justify-center space-x-2 text-sm"
          >
          ...
          <button
            type="button"
            onClick={handleReset}
            className="px-4 py-3.5 bg-slate-800/80 hover:bg-slate-700 text-slate-300 font-semibold rounded-xl border border-white/10 transition text-sm"
          >
            Reset
          </button>
        </div>
