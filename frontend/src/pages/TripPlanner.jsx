...
const TripPlanner = () => {
  ...
  const hasGeneratedTrip = Boolean(tripData && (viewState === 'success' || tripData.total_distance !== undefined));
    ...
    <div className="flex-1 bg-slate-950 text-slate-100 p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          {/* Left Column: Form, Trip Summary & Conditional Driver Manifest Input Form */}
